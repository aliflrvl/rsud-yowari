...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Pengumuman</h2>
          <form method=POST action='?module=pengumuman&act=tambahpengumuman'>
          <input type=submit value='Tambah Pengumuman'></form>
          <table>
  ...
  case "tambahpengumuman":
    echo "<h2>Tambah Pengumuman</h2>
          <form method=POST action='./aksi.php?module=pengumuman&act=input' enctype='multipart/form-data'>
          <table>
  ...
  case "editpengumuman":
    ...
    echo "<h2>Edit Pengumuman</h2>
          <form method=POST action='./aksi.php?module=pengumuman&act=update' enctype='multipart/form-data'>
